...
const Page = () => {
  ...
  return (
    <div className="bg-black text-white font-primary w-full">
      <Navbar />
      <div className="relative z-10 min-h-screen bg-black text-white px-4 md:px-6 py-4 md:pt-12 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="z-20 max-w-6xl mx-auto px-2 grid h-full items-center lg:grid-cols-2 ">
          <div className="">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight pb-2">
              Craft <span className="text-primary">Stunning</span> Interfaces
              with Ease
            </h1>
            <p className="text-sm text-gray-100 mb-5">
              Unlock the power of a next-generation UI component library
              designed for React and Next.js. Lightning-fast, visually polished,
              and endlessly customizable — so your product not only works
              flawlessly but looks unforgettable.
            </p>
