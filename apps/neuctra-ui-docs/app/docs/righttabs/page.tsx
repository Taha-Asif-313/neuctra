...
import { RightTabs } from "@neuctra/ui"; // Adjust import path as needed
import CodeBlock from "@/app/components/docs/CodeBlock";
import CodePreviewBlock from "@/app/components/docs/CodePreviewBlock";
import { Calendar, Mail, User } from "lucide-react";

const RightTabsDocs: React.FC = () => {
  ...
  // Data for RightTabs component props (inherited from TabsBaseProps)
  const data = [
    {
      prop: "tabs",
      type: "TabItem[]",
  ...
  return (
    <div className="py-10 max-w-5xl font-primary mx-auto bg-zinc-950">
      ...
      <h1 className="text-4xl font-bold mb-8">
        <span className="text-primary">RightTabs</span> Component Documentation
      </h1>

      {/* Import Statement */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Import</h2>
        <CodeBlock language="javascript" code={`import { RightTabs } from "@neuctra/ui";`} />
      </section>
...
/>`}
      ...
      <section className="mb-16">
        <p className="text-gray-300 leading-relaxed">
          The <code>RightTabs</code> component provides a vertical tab navigation
          UI positioned on the right side of the container. It supports icons,
