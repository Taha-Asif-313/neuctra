...
import { TopTabs } from "@neuctra/ui"; // Adjust import path as needed
import CodeBlock from "@/app/components/docs/CodeBlock";
import CodePreviewBlock from "@/app/components/docs/CodePreviewBlock";
import { Calendar, Mail, User } from "lucide-react";

const TopTabsDocs: React.FC = () => {
  ...
  // Data for TopTabs component props (inherited from TabsBaseProps)
  const data = [
    {
      prop: "tabs",
      type: "TabItem[]",
    ...
    },
    {
      ...
      type: "string | number",
      default: '"240px"',
      description: "Width of the tabs container (for vertical tabs). Not applicable for top tabs, ignored if provided.",
    },
    {
      prop: "tabGap",
      type: "number",
    ...
    },
    {
      ...
      type: "number",
      default: "768",
      description: "Viewport width in px to switch to mobile drawer mode (mostly for vertical tabs; top tabs remain horizontal).",
    },
    {
      prop: "showDrawerLabel",
      type: "string",
      default: '"Select Tab"',
      description: "Label shown on drawer button in mobile vertical tabs (not applicable for top tabs).",
    },
  ];
  ...
  return (
    <div className="py-10 max-w-5xl font-primary mx-auto bg-zinc-950">
      ...
      <h1 className="text-4xl font-bold mb-8">
        <span className="text-primary">TopTabs</span> Component Documentation
      </h1>

      {/* Import Statement */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Import</h2>
        <CodeBlock language="javascript" code={`import { TopTabs } from "@neuctra/ui";`} />
      </section>
...
/>`}
      ...
      <section className="mb-16">
        <p className="text-gray-300 leading-relaxed">
          The <code>TopTabs</code> component provides a horizontal tab navigation
          UI positioned at the top of the container. It supports icons,
          custom styling via classNames and inline styles, and is responsive,
          though it does not switch to drawer mode on mobile as vertical tabs do.
        </p>
      </section>
...
/>`}
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300">
          <li>The component lays out tabs horizontally at the top of the container.</li>
          ...
          <li>Unlike vertical tabs, <code>TopTabs</code> does not collapse into a drawer on mobile but remains horizontal and scrollable if needed.</li>
